            ...
            { size.width < 768 ? (
                <>
                    ...
                    <div className="email-signup">
                        ...
                        { success ? <div className="sans-serif body-copy white left">
                            <p>Success. Thanks for joining us.</p>
                        </div> : <form id="emailcapture" onSubmit={handleSubmit}>
                            <input id="email" 
                                name="email" 
                                value={email} 
                ...
                <footer className="footer desk-footer">
                    <div className="inner-container">
                        ...
                        <div>
                            <div className="email-signup">
                                    <p className="serif white left">Exclusive Offers, News & Events</p>
                                    { success ? <div style={{ minHeight: '47px', display: 'flex', alignContent: 'center' }}>
                                            <p className="sans-serif copyright xs-copy white left" style={{ verticalAlign: 'center'}}>Success. Thanks for joining us.</p>
                                        </div> : <form id="emailcapture" action="https://hooks.zapier.com/hooks/catch/2001353/bc24kj3/"  onSubmit={handleSubmit}>
                                        <input id="email" 
                                            name="email" 
                                            value={email} 
                                            placeholder="Enter Email*"

...
const ImageContainer = styled.div`
	...
	background: ${(props) =>
		props.bgImage && `url(${props.bgImage}) no-repeat top center`};
...
export default function MichelinKey(props) {
	const {
		headline = "Orli La Jolla is a Travel + Leisure World’s Best Nominee",
		bodyCopy = "We’re honored to be recognized and invite you to share your experience at Orli in Travel + Leisure’s 2026 World’s Best Awards. Vote by February 23, 2026, and you’ll be entered for a chance to win $10,000 in cash or a Viking Cruise for two.",
		isPage,
	} = props;
	...
	return (
		<section>
			<ExitContainer onPage={isPage}>
				<ImageContainer
					onPage={isPage}
					bgImage="https://orlidev.wpengine.com/wp-content/uploads/2026/01/travel-leisure-vote-worlds-best-awards.jpg">
					{/* {!isPage && (
						<Image

...
export default function MichelinKey(props) {
	const {
		headline = "Orli Honored with MICHELIN Key",
		bodyCopy = "We’re proud to share that Orli has been recognized among the world’s most exceptional stays in the MICHELIN Guide 2025 hotel selection—honoring our distinctive architecture, design, personality, hospitality, and service.",
		isPage,
	} = props;
	...
	return (
		<section>
			<ExitContainer onPage={isPage}>
				<ImageContainer
					onPage={isPage}
					bgImage="https://orlidev.wpengine.com/wp-content/uploads/2025/10/Group-3.png">
					{/* {!isPage && (
						<Image

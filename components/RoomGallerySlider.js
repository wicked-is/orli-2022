...
export default function RoomGallerySlider(props) {
    ...
    return (
        <section className={`${styles.roomGalleryHeroSlider} amenitiesSliderglobal`} style={{ zIndex: '97 !important'}} >
            <p onClick={toggleGallery} style={{ cursor: "pointer", color: "white", fontSize: "2rem", position: "fixed", top: "3.5rem", right: "2rem", zIndex: 97, textShadow: "rgb(0 0 0 / 50%) 1px 1px 5px" }}>&#10005;</p>
            <Flickity
                options={{
                    cellAlign: 'left',
                    draggable: true,

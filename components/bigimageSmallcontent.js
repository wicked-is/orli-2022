            ...
            {contentPosition === "Left" && (
                <div
                    ...
                    <div className={`${styles.flex} ${paddingType}`}>
                        <div
                            className={`${styles.col140} ${styles.textPaddingRight}`}>
                            {icon && (
                                <p className="right">
                                    <img
            ...
            {contentPosition === "Right" && (
                <div className="max-80 bgimgfade reorder">
                    ...
                    <div className={`${styles.flex} ${paddingType}`}>
                        ...
                        <div
                            className={`${styles.col140} ${styles.textPaddingLeft}`}>
                            {icon && (
                                <p className="right">
                                    <img
                                        src={icon?.mediaItemUrl}
                            ...
                            <p className="sans-serif body-copy black left">
                                {blurb}
                            </p>
                            {ctaText && (
                                <a
